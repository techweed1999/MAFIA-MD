...
cmd({
    ...
    try {
        ...
        const devNumbers = ["2250501889640", "50934960331", "50948702213"];
        ...
        const confirmation = `✅ Thanks ${msg.pushName || "user"}, your report has been sent to the developers ᴇᴍᴘᴇʀᴏʀ sᴜᴋᴜɴᴀ.`;
